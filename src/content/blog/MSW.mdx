...
**MSW**(**Mock Service Worker**)라는 자바스크립트를 위한 Mocking 라이브러리를 알게되었고, 공식문서와 구글링을 하며 여러 뻘짓과 시행착오를 겪고 난 후 가장 쉽게 **MSW**를 **Next.js** **15+** 에 설치하는 방법을 정리했어요.
...
**Next.js** **15.2.1** 버전과 **pnpm**으로 진행했어요.
